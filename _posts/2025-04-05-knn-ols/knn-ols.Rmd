...
Fortunately, there are packages that implement this idea. Here, I’m going to do that using the `qeLinKNN` function from the [`qeML`](https://cran.r-project.org/web/packages/qeML/index.html) package.
...
The goal here is to predict Circumference based on the variables age and Tree.
